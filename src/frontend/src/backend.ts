...
export class Backend implements backendInterface {
    ...
    async removeEmergencyContact(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await (this.actor as unknown as { removeEmergencyContact: (phone: string) => Promise<void> }).removeEmergencyContact(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllAccidents(): Promise<Array<[Principal, Array<AccidentRecord>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAccidents();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyEmerContacts(): Promise<Array<EmergencyContact>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyEmerContacts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserAccidents(): Promise<Array<AccidentRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAccidents();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reportAccident(arg0: AccidentRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reportAccident(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveProfile(arg0: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveProfile(await to_candid_UserProfile_n17(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendSms(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendSms(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        videoEvidence: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.videoEvidence)),
...
async function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userName: value.userName,
        videoEvidence: value.videoEvidence ? candid_some(await to_candid_ExternalBlob_n19(_uploadFile, _downloadFile, value.videoEvidence)) : candid_none(),
        phoneNumber: value.phoneNumber
    };
}
